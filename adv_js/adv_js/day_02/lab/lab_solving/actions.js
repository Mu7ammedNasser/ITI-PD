...
let book1 = new Book("JS", 10, "Mohamed", 200, "nasserGroup", 5);
let book2 = new Book("Angular", 15, "Nasser", 300, "nasserGroup", 3);
let book3 = new Book("MVC", 12, "ahmed", 250, "nasserGroup", 4);

let myBox = new Box(50, 40, 30, "wood", []);

myBox.addBook(book2);
myBox.addBook(book3);
console.log(myBox.addBook(book3));

console.log(myBox.removeBook("Angular17"));
